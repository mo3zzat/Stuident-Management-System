...
public class Student{
    ...
    public boolean isEmailExist(String email){
        try {
            ps = con.prepareStatement("select email from student where email = ?");
    ...
    public boolean isPhoneExist(String phone){
        try {
            ps = con.prepareStatement("select phone from student where phone = ?");
    ...
    //get all the Student value from database student table
    public void getStudentData(JTable table,String searchvalue){
    ...
    public void update(int id,String sname, String date,String gender, String email,String phone, String father, String mother
            ...
            String sql = "update student set name = ?,date_of_birth = ?, gender = ?, email = ?, phone = ?, father_name = ?, "
                    + "mother_name = ?, address1 = ?, address2 = ?, image_path = ? where id = ?";
        try {
            ps = con.prepareStatement(sql);
    ...
    public void delete(int id){
        int yesNo = JOptionPane.showConfirmDialog(null, "Coures and score records will also be deleted","Student Deleted",JOptionPane.OK_CANCEL_OPTION,0);
